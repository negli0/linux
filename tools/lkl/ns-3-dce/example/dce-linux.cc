...
int main (int argc, char *argv[])
{
 ...
 // processManager.SetNetworkStack ("ns3::LinuxSocketFdFactory", "Library", StringValue ("/home/nelio/work/linux/tools/lkl/liblkl.so"));
  processManager.SetNetworkStack ("ns3::LinuxSocketFdFactory", "Library", StringValue ("/home/nelio/work/linux/tools/lkl/test-liblkl.so"));
